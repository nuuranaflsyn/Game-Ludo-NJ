...
public class Board {
    ...
    public Board() {
        p1 = new Player(1, 'B', "BIRU");
        p2 = new Player(2, 'K', "KUNING");
        p3 = new Player(3, 'H', "HIJAU");
        p4 = new Player(4, 'M', "MERAH");
        d = new Dice(p3);
        ...
        if (s.equalsIgnoreCase("S")) {
            ...
            while (!gameover) {
                ...
                if (s.equalsIgnoreCase("R")) {
                    ...
                    write_to_board_array(64, 86, String.valueOf(dv));
                    displayboard();
                    if (d.checkmove()) {
                        int valid_token = 0;
                        boolean start = true;
                        while (valid_token != 1) {
                            ...
                            try {
                                ...
                                if (valid_token == 100) {
                                    write_to_board_array(66, 11, d.current_player.color + "            ");
                                    updateBoard();
                                    displayboard();
                        ...
                        write_to_board_array(64, 0, "TEKAN \"R\" UNTUK ROLL DADU.");
    ...
    private void gamestarted() {
        d.current_player = p1;
        write_to_board_array(62, 86, "BIRU");
        write_to_board_array(62, 0, "GAME DIMULAI                ");
    }
    ...
    private void updateBoard() {
        ...
        switch (d.current_player.id) {
            case 1:
                ...
                break;
            case 2:
                write_to_board_array(62, 86, "KUNING");
                break;
            case 3:
                write_to_board_array(62, 86, "HIJAU");
                break;
            case 4:
                write_to_board_array(62, 86, "MERAH");
                break;
            default:
                System.out.println("");
                break;
    ...
    void set_turn() {
        ...
        write_to_board_array(64, 86, String.valueOf(" "));
        write_to_board_array(66, 86, String.valueOf(d.last_value));
    }
